...
pub const RENDEZVOUS_SERVERS: &[&str] = &["sq5.mossfrp.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "gcmqmWdcq8+f6ZJ7OqI0pMM0GSwIZfBMKN2NTnuEJwI=";
...
pub const RENDEZVOUS_PORT: i32 = 46711;
pub const RELAY_PORT: i32 = 46712;
